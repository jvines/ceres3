...
from ceres3.instruments import hiresutils
...
order_dir  = os.path.join(_data_dir, 'hires_wavcals/')
...
if (pre_process == 1):
    ...
    pickle.dump(trace_dict, open(dirout+'trace_' + str(int(chip)) + '.pkl', 'wb'))

else:
    trace_dict = pickle.load(open(dirout+'trace_' + str(int(chip, 'rb'), encoding='latin1') + '.pkl' ) )
